...
if ($resultOrder->num_rows > 0) {
	...
	while ($row = $resultOrder->fetch_assoc()) {
		if ($row['u_id'] == $userLogin['u_id'] && $row['o_status'] == 0) {
					...
					<div class="col-lg-6 text-center text-lg-right">
						<div class="d-inline-flex align-items-center">
							...
							<div class="data1">
								...
								<a href="register.php" class="btn2 btn-primary2 mt-1" style="color: #49243E;"><b><?php echo $userLogin["u_id"]; ?>
										/</b></a>
							</div>
							<div class="data2">
								<i style="color: #49243E;" class=""></i>
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<?php foreach ($order_array as $item) : ?>
									<?php if ($item['u_id'] == $userLogin['u_id'] && $item["o_quantity"] > 0 && $item["o_status"] == 0) ?>
									<tr class="table_row">
										<td class="column-1">
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span class="mtext-110 cl2">
									$ <?php echo sumTotalPrice($order_array, $userLogin["u_id"]); ?>
								</span>
							</div>
						</div>
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								...
								if ($discount['d_amount'] > 0) {
									...
									echo '<del>$' . sumTotalPrice($order_array, $userLogin["u_id"]) . '</del>';
									$discountedPrice = sumTotalPrice($order_array, $userLogin["u_id"]) * (100 - $discount['d_amount']) / 100;
									...
									echo '<span class="mtext-110 cl2">$' . sumTotalPrice($order_array, $userLogin["u_id"]) . '</span>';
								}
								?>
							</div>
						</div>
